...
int main (void)
{
	...
	int i = 0;
	auto gpio4 = GPIO{4, Direction::In}; //create new GPIO object to be attached to  GPIO4
	auto gpio17 = GPIO{17, Direction::Out}; //create new GPIO object to be attached to  GPIO17
